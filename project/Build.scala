...
object ShifterBuild extends Build {
  ...
  .aggregate(core, db, migrations, cache, json, httpClient, geoip, webApi, webJetty8, webJetty9, webSample)
  .dependsOn(core, db, migrations, cache, json, httpClient, geoip, webApi)
